...
function build_rpm() {
    ...
    sudo cp /vagrant/amqpinflux/build.spec /root/rpmbuild/SPECS
...
CORE_TAG_NAME="tmp_m5"
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-packager/3.4m5/common/provision.sh -o ./common-provision.sh &&
